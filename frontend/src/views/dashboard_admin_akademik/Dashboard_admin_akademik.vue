    ...
    <div class="bg-[#eef3fb] min-h-screen overflow-y-auto overflow-x-hidden">
        ...
        >
            ...
            >
                ...
                <div class="text-white font-medium">Admin Akademik</div>
            </div>
        </header>
        ...
        >
            ...
            <div class="p-3 space-y-1">
                ...
                <div>
                    ...
                    >
                        ...
                        >
                            <path
                                stroke-linecap="round"
                                stroke-linejoin="round"
                                d="M12 14 9-3m0 0-3 3m3-3 3 3M3 20.25h18"
                            />
                        </svg>
                    ...
                    <!-- SUB MENU -->
                    <div
                        v-if="openAkademik && isSidebarOpen"
                ...
                <div>
                    <div
                        @click="openMahasiswa = !openMahasiswa"
                        class="flex cursor-pointer items-center gap-3 rounded-lg px-4 py-3 text-gray-700 hover:bg-[#b8c9e2] transition"
                    >
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div
                        v-if="openMahasiswa && isSidebarOpen"
                        class="ml-3 mt-1 space-y-1"
                    >
                        <div
                            @click="goTo('/dashboard-admin/peserta_kelas')"
                            :class="
                                isActive('/dashboard-admin/peserta_kelas')
                                    ? 'bg-[#1f3c93] text-white'
                                    : 'text-gray-700 hover:bg-[#b8c9e2]'
                            "
                            class="flex cursor-pointer items-center gap-3 rounded-lg px-4 py-2 transition"
        ...
        >
            ...
            <div v-if="route.path === '/dashboard-admin'">
                ...
                <div class="grid grid-cols-3 gap-4 mb-6">
                    <!-- Total Pegawai -->
                    <div
                        class="bg-white rounded-xl p-4 flex items-center gap-4 shadow-[0_8px_25px_rgba(59,130,246,0.25)]"
                    >
                    ...
                    >
                        <div class="bg-[#a9c3e3] p-4 rounded-lg">
                            <i
                                class="fi fi-rr-student text-3xl text-[#1f3c93]"
                            ></i>
                        </div>
                        <div>
                            <p class="text-sm font-semibold text-gray-500">
                ...
                <div class="grid grid-cols-4 gap-4">
                    <!-- TABLE -->
                    <div
                        class="col-span-3 bg-white rounded-xl p-5 shadow-[0_8px_25px_rgba(59,130,246,0.25)]"
                    >
                        ...
                        <div class="bg-white rounded-xl p-5 shadow">
                            ...
                            <div class="flex items-center justify-between mb-3">
                                ...
                                <button
                                    @click="
                                        goTo(
                                            '/dashboard-admin/dashboard_tahunakademik',
                                        )
                                    "
                            ...
                            <!-- DATA -->
                            <div
                                v-for="item in tahunAkademik.slice(0, 4)"
                                :key="item.id"
                        ...
                        <div class="bg-white rounded-xl p-5 shadow">
                            ...
                            <div class="flex items-center justify-between mb-3">
                                ...
                                <button
                                    @click="
                                        goTo(
                                            '/dashboard-admin/dashboard_kurikulum',
                                        )
                                    "
                                    class="text-blue-600 hover:text-blue-800"
                                >
                            ...
                            <!-- DATA -->
                            <div
                                v-for="item in kurikulum.slice(0, 4)"
                                :key="item.id"
                                class="bg-gray-50 rounded-lg p-3 mb-2"
                            >
                                {{ item.name }}
